...
class VisionTrainerCustom:
    ...
    def __init__(
        ...
        # Set up the metric
        self.metric = torchmetrics.Accuracy('multiclass', num_classes=len(list(self.labels2ids.keys())))
    ...
    def evaluate_f1_score(self):
        ...
        all_target, all_preds = self.evaluate(dataset=self.test)
