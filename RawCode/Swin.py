...
root = "raw_data/"
x_train = np.load(root + f"train_img_{image_dimension}x{image_dimension}x3.npy")
y_train = np.load(root + "train_label_ctg_3.npy")
x_test = np.load(root + f"test_img_{image_dimension}x{image_dimension}x3.npy")
y_test = np.load(root + "test_label_ctg_3.npy")
