...
root = "raw_data/"
x_train = np.load(root + "train_img_72x72.npy")
y_train = np.load(root + "train_label_72x72.npy")
x_test = np.load(root + "test_img_72x72.npy")
y_test = np.load(root + "test_label_72x72.npy")
...
vit_sl = create_vit_classifier(vanilla=True)
history, model = run_experiment(vit_sl)
